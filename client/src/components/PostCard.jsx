...
export default function PostCard({post}) {
  return (
    <div className="group relative w-full border border-teal-500 hover:border-2 h-[380px] overflow-hidden rounded-lg sm:w-[430px] md:w-[300px] lg:w-[280px] transition-all ">
